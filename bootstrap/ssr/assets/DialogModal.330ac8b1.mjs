import { mergeProps, withCtx, renderSlot, useSSRContext, watch, onMounted, onUnmounted, computed, unref, createVNode } from "vue";
...
import { S as SectionTitle } from "./SectionTitle.2005f81b.mjs";
const _sfc_main$2 = {
